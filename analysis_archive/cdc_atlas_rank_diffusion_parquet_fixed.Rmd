...
need_pkgs <- c(
  ...
  "minpack.lm","RcppRoll","slider","glue","arrow","MASS"
)
...
suppressPackageStartupMessages({
  # Attach dplyr AFTER any masking packages; avoid attaching MASS to keep dplyr::select intact
  ...
  # Do not library(MASS); we call MASS::rlm and MASS::psi.huber explicitly
})
...
fit_huber <- MASS::rlm(v_k ~ 1, data = rank_stats, weights = n_k, psi = MASS::psi.huber, maxit = 200)
